...
//  WeatherApp
//
//  Created by Ceren Güneş on 17.11.2022.
//
    ...
    var body: some View {
        ZStack {
            ...
            VStack(spacing: 10) {
                ...
                mainWeatherStatusView(imageName: isNight ? "cloud.sleet.fill" : "cloud.sun.fill", temperature: "76")
                ...
                HStack {
                    Button {
                        ...
                        WeatherButton(title: "Change Time of Day", textColor: Color.blue, backgroundColor: .white)
                    }
                }
